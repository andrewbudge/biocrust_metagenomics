...
```{r lovis4u-proviruses, echo=FALSE, fig.cap="Linear gene maps of 4 Brevundimonas proviruses annotated by Pharokka, with homology links between shared genes."}
knitr::include_graphics("data/genome_classification/genomes/Brevundimonas_sp_M20/lovis4u_output/lovis4u_hires-1.png")
```
