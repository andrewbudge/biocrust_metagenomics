...
Raw reads were filtered using `chopper` with a minimum quality score of 20 and a minimum read length of 1,000 bp. Less than 500 reads per sample were removed, so we have very high quality data.
...
Taxonomic classification done using Kraken2 with the PlusPF-8 database, which includes bacterial, archaeal, viral, fungal, and protozoan reference sequences. 
