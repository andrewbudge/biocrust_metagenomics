...
# example: bash scripts/extract_proviruses.sh SRR35809155_ctg370 data/genomes/bacterial/annotations/Brevundimonas_sp_M20/pharokka
...
seqkit grep -r -p "$CONTIG_ID" \
    data/genomes/genomad_output/circular_contigs_find_proviruses/circular_contigs_provirus.fna \
